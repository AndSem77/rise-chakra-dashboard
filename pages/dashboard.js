      ...
      >
        ...
        >
          ...
          <Flex flexDir='column' alignItems='center' mb={10} mt={5}>
            ...
            <Text textAlign='center'>Andrey</Text>
          </Flex>
        </Flex>
      </Flex>
      ...
      >
        ...
        {value == 1 && (
          <Box
            ...
            w='100%'
            h='200px'
            bgGradient='linear(to-t, #eee, #6EE7B7)'
          >
            <Flex
              p='1em'
              color='#fff'
            ...
            >
              <Flex justify='space-between' w='100%' align='flex-start'>
                <Flex flexDir='column'>
                  <Text color='gray.900'>Current Balance</Text>
                  <Text fontWeight='bold' fontSize='xl' color='gray.700'>
                    $5,750.20
                  </Text>
                </Flex>
                <Flex align='center'>
                  <Icon mr={2} as={FiCreditCard} color='gray.700' />
                  <Text color='gray.700'>Rise.</Text>
                </Flex>
              </Flex>
